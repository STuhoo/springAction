...
public class BeanLifeCycle {
    private static void LifeCycleInBeanFactory(){
 	   ...
 	   System.out.println("---Hereafter: configure Spring IoC Context---");
       //①下面两句装载配置文件并启动容器
       ...
       System.out.println("---Hereafter: start bean IoC---");
       ...
       //将com.smart.beanfactory/beans.xml中的car bean的scope="prototype"，则car1<>car2
